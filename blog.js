// Seotize Blog Loader v2.1 (FIXED)
// Fixes CSS injection bug by using .textContent and minifying the CSS string.
(() => {
    ...
    // **CRITICAL FIX**: Minified CSS string to prevent any newline interpretation.
    ...
    // **CRITICAL FIX**: Use .textContent instead of .innerText to safely inject styles as raw text.
